...
exports.get = function(filter, cb) {
    ...
    let sqlQuery = 'SELECT flight, seat_row, seat, class, departure, destination, departure_date, arrival_date, flight_number FROM tbl_tickets AS t LEFT JOIN tbl_flights AS f ON t.flight = f.id WHERE reserver IS NULL' +
